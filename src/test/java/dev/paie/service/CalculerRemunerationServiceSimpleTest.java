...
@ContextConfiguration(classes = { ServicesConfig.class, JeuDonneesConfig.class })
...
public class CalculerRemunerationServiceSimpleTest {
	...
	@Autowired
	private BulletinSalaire bulletinJdd;

	@Test
	public void test_calculer() {
		// TODO remplacer null par un objet bulletin
		ResultatCalculRemuneration resultat = remunerationService.calculer(bulletinJdd);
